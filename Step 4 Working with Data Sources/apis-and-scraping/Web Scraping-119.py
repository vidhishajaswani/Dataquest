...
a=parser.select(".outer-text")
first_outer_text=a[0].text

b=parser.select("#second")
second_text=b[0].text
...
a=parser.select("#total-plays")
patriots_total_plays_count=a[0].select("td")[2].text

b=parser.select("#total-yards")
seahawks_total_yards_count=b[0].select("td")[1].text