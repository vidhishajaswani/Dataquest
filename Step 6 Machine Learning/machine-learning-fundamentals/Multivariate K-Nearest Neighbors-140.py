...
dc_listings=dc_listings.drop(labels=['room_type','city','state','latitude','longitude','zipcode','host_response_rate','host_acceptance_rate','host_listings_count'],axis=1)
...
one=normalized_listings.iloc[0][['accommodates', 'bathrooms']]
two=normalized_listings.iloc[4][['accommodates', 'bathrooms']]
first_fifth_distance = distance.euclidean(one,two)
